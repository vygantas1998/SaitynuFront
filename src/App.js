...
import PlayerStatList from "./Pages/PlayerStats/PlayerStatList";
      ...
      <Router>
        <Switch>
          ...
          <Route path="/matches/:id">
            <PageWithNavigation page={<MatchDetails isAdmin={this.state.isAdmin} />} logout={this.logout} />
          </Route>
          <Route path="/matches">
            <PageWithNavigation page={<MatchList isAdmin={this.state.isAdmin} />} logout={this.logout} />
          </Route>
          <Route path="/login">
